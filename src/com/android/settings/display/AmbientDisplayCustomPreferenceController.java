...
public class AmbientDisplayCustomPreferenceController extends AbstractPreferenceController implements
        ...
        if (KEY_AMBIENT_DISPLAY_CUSTOM.equals(preference.getKey())) {
            ...
            try {
                ...
                if (Build.PRODUCT.equals("Moto G5 Plus")) {
                    intent.setClassName(
                            "com.pixeldust.settings.device",
                            "com.pixeldust.settings.device.DozeSettingsActivity");
                } else {
                    intent.setClassName(
    ...
    public boolean isAvailable() {
        return PixeldustUtils.hasAltAmbientDisplay(mContext.getApplicationContext());
    }

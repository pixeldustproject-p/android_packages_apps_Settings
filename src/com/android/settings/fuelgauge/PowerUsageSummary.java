...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
        ...
        if (KEY_BATTERY_HEADER.equals(preference.getKey())) {
            ...
            if (batteryTemp) {
                mBatteryTemp.setSubtitle(
                    com.android.internal.util.pixeldust.PixeldustUtils.batteryTemperature(getContext(), false));
                batteryTemp = false;
            } else {
                mBatteryTemp.setSubtitle(
                    com.android.internal.util.pixeldust.PixeldustUtils.batteryTemperature(getContext(), true));
                batteryTemp = true;
            }
        }
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.pixeldust.PixeldustUtils.batteryTemperature(getContext(), batteryTemp));
